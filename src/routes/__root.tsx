...
const APP_NAME = "Outlook-gids";
const APP_DESCRIPTION =
  "Handleidingen voor 1ste bachelor Bedrijfsmanagement: terugkerende afspraken, zoeken en filters in Outlook.";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#2C5F6E" },
    ],
    links: [
